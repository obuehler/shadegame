...
public abstract class StageObjectIcon extends NewStageIcon {
	...
	public StageObjectIcon(int x, int y, StageEditor s) {
		super(x, y, s);
		preInitializeIcon();
		setObject(x, y);
		initializeIcon();
	...
	public StageObjectIcon(StageType e, int x, int y, StageEditor s) {
		super(x, y, s);
		preInitializeIcon();
		setObject(e, x, y);
		initializeIcon();
	...
	public StageObjectIcon(Vector2 o, StageEditor e) {
		super(Math.round(o.x * Constants.DEFAULT_SCALE),
	...
	protected void preInitializeIcon() {
