...
public class Helpers {
	...
	public static int confirmQuit(StageEditor s) {
		return JOptionPane.showConfirmDialog(s, "Do you want to save your changes before you quit?", "Quit", JOptionPane.YES_NO_CANCEL_OPTION);
	}
	...
	public static int confirmNewEditor(StageEditor s) {
		return JOptionPane.showConfirmDialog(s, "Do you want to op" +
				"en a new editor? If so, click \"Yes.\" If you choose" +
				" \"No,\", your changes to the current stage will be lo" +
				"st because Emre is a lazy ass and did not implement multipl" +
				"e stages in a single editor.", "Attention!", 
				JOptionPane.YES_NO_CANCEL_OPTION);
	}
