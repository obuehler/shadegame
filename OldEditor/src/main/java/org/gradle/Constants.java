...
public class Constants {
	...
	static {
		...
		config.width = standardWidth();
		config.height = standardHeight();
		config.resizable  = false;
		config.title = "Troll Stomp";
		config.fullscreen = false; // RETINA MACS DO NOT SUPPORT FULLSCREEN (LWJGL Bug)
		config.addIcon(ASSETS_PATH() + "images/icon128.png" , Files.FileType.Internal);
		config.addIcon(ASSETS_PATH() + "images/icon32.png", Files.FileType.Internal);
		config.addIcon(ASSETS_PATH() + "images/icon16.png", Files.FileType.Internal);
	...
	public static final String BACKGROUNDS_PATH() { return "images" + FILE_SEPARATOR + "backgrounds" + FILE_SEPARATOR; }
	// public static final String ASSETS_PATH() { return ".." + FILE_SEPARATOR + "core" + FILE_SEPARATOR + ASSETS_FOLDER_NAME + FILE_SEPARATOR; }
	// public static final String ASSETS_PATH() {return "bin" + FILE_SEPARATOR; }
	public static final String ASSETS_PATH() {return ""; }
	public static final String STAGES_PATH() { return ASSETS_PATH() + STAGES_FOLDER_NAME + FILE_SEPARATOR; }
	public static final String DOTTED_STAGE_FILE_EXTENSION() { return "." + STAGE_FILE_EXTENSION; }
